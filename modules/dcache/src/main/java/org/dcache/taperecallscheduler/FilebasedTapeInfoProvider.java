...
public class FilebasedTapeInfoProvider implements TapeInfoProvider, CellMessageReceiver, CellInfoProvider {
    ...
    private void initializeTapeInfo() {
        ...
        LOGGER.warn("Tape info map initialized: {} entries added", tapeInfo.size());
    }
    ...
    private void initializeTapefileInfo() {
        ...
        String fileid; // pnfsid!? now just srm path
        long filesize; // KB
        String tapename;
        ...
        LOGGER.warn("Tapefile info map initialized: {} entries added", tapeFileInfo.size());
    }
