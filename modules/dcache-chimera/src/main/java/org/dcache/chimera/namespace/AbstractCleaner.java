...
public abstract class AbstractCleaner implements LeaderLatchListener
{
    ...
    @Required
    public void setHaServiceLeadershipManager(HAServiceLeadershipManager haServiceLeadershipManager) {
        _haServiceLeadershipManager = Objects.requireNonNull(haServiceLeadershipManager);
    }
    ...
    protected void cancelCleanerTask() {
